...
class NetworkManager{
    ...
    static func createUser(firstName:String ,lastName:String, email:String, password:String, configPassword:String , completionHandler:@escaping (User)->Void){
        let parameters : Parameters = ["customer":["first_name":"\(firstName)","last_name":"\(lastName)","email":"\(email)","phone":"+10242546123","verified_email":true,"addresses":[["address1":"123 Oak St","city":"\(password)","province":"\(configPassword)","phone":"555-1212","zip":"123 ABC","last_name":"Lastnameson","first_name":"Mother","country":"CA"]]]]
